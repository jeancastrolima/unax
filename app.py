...
# --- CSS GLOBAL COM BOOTSTRAP E ROBOTO ---
st.markdown("""
    <!-- Importando Roboto e Bootstrap -->
    <link href="https://fonts.googleapis.com/css2?family=Roboto:wght@400;500;700&display=swap" rel="stylesheet">
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">

    <style>
        /* Fonte Roboto para todo o app */
        html, body, [class*="css"]  {
            font-family: 'Roboto', sans-serif;
        }

        /* Layout responsivo e largura total */
        .stApp {
        ...
        /* Tabelas dataframes */
        .dataframe-container, .stDataFrame>div>div {
            width: 100% !important;
...
# --- EXEMPLO DE USO ---
st.title("✨ Plataforma AlexExpert - Visual Moderno")
st.header("Interface Renovada com Bootstrap e Roboto")
st.write("Esta página agora utiliza a fonte Roboto, cores modernas e aproveita toda a largura da tela.")
